...
| # | Bug | Perbaikan |
|---|-----|-----------|
| 1 | `Anchor = 'TopRight'` (LinkLabel hak cipta) -> *AnchorStyles* tidak mengenali nama itu, berpotensi crash saat start | Diganti `'Top, Right'` |
| 2 | Label tab RAM masih "RAM & RAMMap" | Diganti "RAM" |
| 3 | `Delete-OptiCacheUi`: ukuran basi & folder yang sudah tak ada ikut ditandai "Dibersihkan" | `$freed` direset per folder; folder tak ada => "Tidak Ada" |
